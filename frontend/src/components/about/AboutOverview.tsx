...
const TAB_CONTENT: Record<TabId, { label: string; heading: string; body: string }> = {
  import: {
...
const TAB_ACTIVE_CLASS = "bg-white text-[#B06518] shadow-[0_2px_8px_rgba(0,0,0,0.06)] font-extrabold border border-[#B06518]";
const TAB_IDLE_CLASS = "text-neutral-500 hover:text-neutral-800 hover:bg-white/40";
...
export default function AboutOverview() {
  ...
  return (
    <section id="ve-chung-toi" className="bg-[#FAFAFA]" style={{ padding: "clamp(40px, 5vw, 64px) 0" }}>
      <div className="container-gooli">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between" style={{ marginTop: "32px" }}>
