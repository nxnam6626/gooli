    ...
    <main className="flex-1 bg-white">
      ...
      >
        <div className="container-gooli">
          ...
          <div
            className="grid grid-cols-1 lg:grid-cols-2 max-w-6xl mx-auto items-stretch"
            style={{ gap: "32px" }}
          >
            {/* Left: Contact Info */}
            <div
              className="flex flex-col justify-between border border-neutral-200 bg-[#FAF8F5]"
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  ...
                  <div className="flex items-start" style={{ gap: "16px" }}>
                    <div className="flex-shrink-0 w-10 h-10 bg-white border border-neutral-200 flex items-center justify-center">
                      <svg className="w-5 h-5 text-[#B06518]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest" style={{ marginBottom: "4px" }}>Địa chỉ</p>
                  ...
                  <div className="flex items-start" style={{ gap: "16px" }}>
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest" style={{ marginBottom: "4px" }}>Hotline</p>
                  ...
                  <div className="flex items-start" style={{ gap: "16px" }}>
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest" style={{ marginBottom: "4px" }}>Email</p>
                  ...
                  <div className="flex items-start" style={{ gap: "16px" }}>
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest" style={{ marginBottom: "4px" }}>Mã số thuế</p>
            ...
            {/* Right: Google Maps */}
            <div className="border border-neutral-200 overflow-hidden min-h-[400px] lg:min-h-0">
              <iframe
