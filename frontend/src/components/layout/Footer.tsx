    ...
    >
      ...
      <div className="container-gooli px-4 md:px-6">
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Trang chủ
              </Link>
              <Link href="/gio-thieu" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Giới thiệu doanh nghiệp
              </Link>
              <Link href="/bao-gia" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Bảng báo giá vật liệu
              </Link>
              <Link href="/du-an" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/san-pham/lam-trong-nha" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Lam gỗ nhựa trong nhà
              </Link>
              <Link href="/san-pham/lam-ngoai-troi" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Lam gỗ nhựa ngoài trời
              </Link>
              <Link href="/san-pham/tam-nano" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Tấm ốp nhựa phẳng Nano
              </Link>
              <Link href="/san-pham/la-phong" className="footer-link rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                Hệ thống trần nhôm caro
              </Link>
            </div>
          </div>

          {/* Column 4: Contact Us (Mockup Clean Boxed List) */}
          <div className="flex flex-col gap-4">
            <span className="text-xs font-bold uppercase tracking-widest text-[#B06518]">
              LIÊN HỆ VỚI GOOLI
            </span>
            <div className="flex flex-col gap-3">
              <a href="tel:0988777666" className="footer-contact-box rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                {/* Chat/Phone Icon */}
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="footer-contact-box rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                {/* Facebook Icon */}
                <svg aria-hidden="true" className="w-4 h-4 text-[#B06518]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="footer-contact-box rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                {/* YouTube Icon */}
                <svg aria-hidden="true" className="w-4 h-4 text-[#B06518]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <Link href="/lien-he" className="footer-contact-box rounded-sm focus-visible:ring-2 focus-visible:ring-[#B06518] focus-visible:outline-none">
                {/* Location Icon */}
                <svg aria-hidden="true" className="w-4 h-4 text-[#B06518]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        >
          ...
          {/* Social Row icons (Unified Segmented Grid) */}
          <div className="flex items-center border border-[#E6DED4] dark:border-neutral-800 rounded-sm divide-x divide-[#E6DED4] dark:divide-neutral-800 bg-white dark:bg-neutral-900 overflow-hidden">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="Twitter X Gooli"
              className="w-8 h-8 flex items-center justify-center text-[11px] font-bold text-neutral-700 dark:text-neutral-300 hover:bg-[#B06518] hover:text-white focus-visible:bg-[#B06518] focus-visible:text-white focus-visible:outline-none transition-colors duration-200"
            >
              X
            </a>
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="Instagram Gooli"
              className="w-8 h-8 flex items-center justify-center text-neutral-700 dark:text-neutral-300 hover:bg-[#B06518] hover:text-white focus-visible:bg-[#B06518] focus-visible:text-white focus-visible:outline-none transition-colors duration-200"
            >
          ...
          <div className="flex items-center gap-3 text-[10px] font-bold text-neutral-400 dark:text-neutral-500 uppercase tracking-widest">
            <Link href="/tuyen-dung" className="hover:text-[#B06518] focus-visible:text-[#B06518] focus-visible:outline-none transition-colors duration-150">
              TUYỂN DỤNG
            </Link>
            <span>|</span>
            <Link href="/chinh-sach" className="hover:text-[#B06518] focus-visible:text-[#B06518] focus-visible:outline-none transition-colors duration-150">
              BẢO MẬT
            </Link>
            <span>|</span>
            <Link href="/tin-tuc" className="hover:text-[#B06518] focus-visible:text-[#B06518] focus-visible:outline-none transition-colors duration-150">
              TRUYỀN THÔNG
            </Link>
          </div>
