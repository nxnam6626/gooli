...
export default function Footer() {
  const { logo, phone, facebook, zalo, linkedin, categories } =
    useWebsiteSettings();
  ...
  const dynamicSocialLinks = [
    ...
    {
      href: linkedin || CONTACT_INFO.linkedin,
      label: 'in',
      aria: 'LinkedIn Gooli',
    },
  ];
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-xs leading-relaxed text-neutral-500 dark:text-neutral-400">
              Gooli Việt Nam là đơn vị hàng đầu chuyên cung cấp giải pháp trần
              nhôm chuyên nghiệp, tấm ốp lam sóng nhựa và phụ kiện trần vách ván
              lợp treo đồng bộ chính hãng.
            </p>
