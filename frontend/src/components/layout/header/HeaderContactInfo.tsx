...
export default function HeaderContactInfo({ address, phone }: HeaderContactInfoProps) {
  return (
    <div className="hidden md:flex items-center gap-8 text-sm text-neutral-600 dark:text-neutral-400">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="font-semibold text-neutral-800 dark:text-neutral-200">{address}</p>
        </div>
      </div>
      <div className="flex items-center gap-2">
