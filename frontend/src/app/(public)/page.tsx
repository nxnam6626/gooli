...
export default function Home() {
  ...
  return (
    <main className="flex-1 bg-[#FAFAFA] dark:bg-neutral-950 pb-16">
      <div
        className="container-gooli pb-6 lg:pb-8"
        style={{ paddingTop: '20px' }}
      >
        <div
          className={`flex flex-col lg:flex-row gap-5 items-stretch transition-all duration-300 ${isExpanded ? 'lg:h-[600px]' : 'lg:h-[450px]'}`}
        >
