...
export default function ExcelImportReceiptsPage() {
  ...
  const [errors, setErrors] = useState<
    { row: number; item: string; error: string }[]
  >([]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">
              Nhập hàng hàng loạt qua Excel
            </h1>
            <p className="text-slate-500 mt-1">
              Hỗ trợ lập nhiều phiếu nhập kho, tự động cộng kho đạt chuẩn và ghi
              nhận dư nợ nhà cung cấp gối đầu.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <form
            ...
            className="bg-white border border-slate-200 rounded-lg p-6 shadow-xs space-y-6"
          >
            <h2 className="text-lg font-bold text-slate-800">
              Tải lên tài liệu chứng từ
            </h2>
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                <UploadSimple
                  size={48}
                  className={file ? 'text-[#B06518]' : 'text-slate-400'}
                />
                {file ? (
                  <div className="space-y-1">
                    <p className="font-bold text-slate-800">{file.name}</p>
                    <p className="text-xs text-slate-500">
                      {(file.size / 1024).toFixed(1)} KB - Nhấp vào đây để đổi
                      file khác
                    </p>
                  </div>
                ) : (
                  <div className="space-y-1">
                    <p className="font-bold text-slate-700">
                      Kéo thả file Excel nhập kho vào đây
                    </p>
                    <p className="text-slate-400 text-xs">
                      hoặc click để duyệt file từ máy tính của bạn (.xlsx, .xls)
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="flex gap-3 items-center bg-emerald-50 text-emerald-800 p-4 rounded-md border border-emerald-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-600 mt-0.5">
                    Đã lập thành công {importCount} phiếu nhập kho tự động, cộng
                    kho và ghi nợ gối đầu NCC khớp 100%.
                  </p>
                </div>
              </div>
            )}
          ...
          {errors.length > 0 && (
            <div className="bg-white border border-red-200 rounded-lg shadow-sm overflow-hidden">
              <div className="bg-red-50 border-b border-red-150 px-6 py-3.5 flex items-center gap-2 text-red-700 font-bold">
                <Warning size={18} />
                <span>
                  Phát hiện dữ liệu không hợp lệ ({errors.length} lỗi) - Đã hủy
                  bỏ toàn bộ giao dịch để bảo toàn số liệu
                </span>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-xs space-y-4">
            ...
            <p className="text-slate-500 leading-relaxed text-xs">
              Mọi lô hàng nhập kho đều phải điền đúng định dạng cột tiêu đề mẫu.
              Hệ thống kiểm soát tính toàn vẹn và từ chối lưu nếu phát hiện sai
              lệch.
            </p>
            ...
            <div className="space-y-3.5 text-xs">
              <div className="flex gap-2">
                <span className="w-4 h-4 bg-amber-100 text-[#B06518] rounded-full flex items-center justify-center font-bold flex-shrink-0">
                  1
                </span>
                <div>
                  ...
                  <p className="text-slate-500 mt-0.5">
                    Phải là Mã nhà cung cấp trong hệ thống (Ví dụ:
                    `NCC-ALU-FRANCE`).
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-slate-500 mt-0.5">
                    Dùng để đối chiếu công nợ & VAT đầu vào. Các hàng cùng số
                    hóa đơn sẽ gộp thành 1 phiếu.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-slate-500 mt-0.5">
                    Mã sản phẩm đã khai báo trước trên Web (Ví dụ:
                    `ALU-U-SHAPED`).
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-slate-500 mt-0.5">
                    `Số lượng` phải là số nguyên &gt; 0. `Đơn giá nhập` là giá
                    gốc trước thuế. `Thuế suất VAT` điền số từ 0 - 100.
                  </p>
                </div>
              </div>
            </div>
