...
export const metadata: Metadata = {
  ...
  keywords: ["trần nhôm", "linh phụ kiện xây dựng", "GOOLI", "thi công trần nhôm"],
...
export default function RootLayout({
  ...
  return (
    <html lang="vi" className={`${outfit.variable} h-full antialiased`} data-scroll-behavior="smooth">
