      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs space-y-3">
          <div className="text-[10px] font-extrabold text-slate-800 uppercase tracking-wider border-b border-slate-100 pb-2 flex items-center justify-between">
            ...
            <span className="text-[#2563eb] text-[9px] lowercase tracking-normal font-semibold hover:underline cursor-pointer">
              Nhập kho
            </span>
          </div>
        ...
        <div className="bg-[#fef2f2] border border-red-100 rounded-xl p-4 shadow-2xs flex flex-col justify-center space-y-2">
          ...
          <div className="flex items-baseline gap-1.5 mt-1">
            ...
            <span className="text-red-800 font-extrabold text-[11px]">
              SKU sắp hết
            </span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-2xs space-y-3">
          <div className="text-[10px] font-extrabold text-slate-800 uppercase tracking-wider border-b border-slate-100 pb-2 flex items-center justify-between">
            <span>Giao dịch gần đây</span>
            <span className="text-emerald-600 text-[9px] lowercase tracking-normal font-semibold hover:underline cursor-pointer">
              Xuất kho
            </span>
          </div>
          <div className="space-y-3">
                  ...
                  {filteredProducts.map((p) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`py-3.5 px-4 text-right font-black font-mono ${isLow ? 'text-rose-600' : isOut ? 'text-slate-400' : 'text-slate-800'}`}
                        >
                          {p.stock || 0}
                        </td>
                        ...
                        <td className="py-3.5 px-4 text-center">
                          <span
                            className={`px-2 py-0.5 rounded-full border text-[9px] font-bold ${statusStyle}`}
                          >
                            {statusLabel}
                          </span>
                        </td>
