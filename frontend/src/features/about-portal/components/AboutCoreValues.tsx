...
export default function AboutCoreValues() {
  return (
    <section className="bg-white border-t border-neutral-100" style={{ padding: "clamp(40px, 5vw, 64px) 0" }}>
      <div className="container-gooli">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto" style={{ gap: "32px" }}>
          {coreValues.map((item) => (
            <div key={item.title} className="flex flex-col items-center text-center p-4 transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="font-bold text-neutral-900 tracking-wider text-sm" style={{ marginBottom: "12px" }}>
                {item.title}
              </h3>
