    ...
    >
      <div className="container-gooli">
        ...
        >
          ...
          >
            <div
              className="flex flex-col sm:flex-row sm:items-stretch w-full"
              style={{ gap: '24px' }}
            >
              <div
                className="flex-shrink-0 sm:w-52 flex flex-col"
                style={{ gap: '12px' }}
              >
                <span
              ...
              >
                ...
                <ContactItem label="Hotline" icon={<PhoneIcon />}>
                  <a
                    ...
                    className="text-sm text-neutral-700 font-medium hover:text-[#B06518] transition-colors duration-200"
                  >
                    {phone}
                  </a>
                </ContactItem>
                ...
                <ContactItem label="Mã số thuế" icon={<TaxIcon />}>
                  <p className="text-sm text-neutral-700 font-medium font-mono">
                    0111469615
                  </p>
                </ContactItem>
              </div>
...
function AddressIcon() {
  return (
    <svg
      className="w-3.5 h-3.5 text-[#B06518]"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      strokeWidth="1.5"
