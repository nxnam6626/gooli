...
export const detectLinkType = (href: string, label: string): "auto" | "system" | "custom" => {
...
export const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>, callback: (base64: string) => void) => {
