        ...
        >
          ...
          <div className="absolute bottom-4 left-4 bg-[#bc6f21] w-16 h-16 rounded-md shadow-sm flex items-center justify-center p-2">
            <div className="text-center text-white">
              <svg
                className="w-6 h-6 mx-auto mb-1 fill-current"
                viewBox="0 0 24 24"
              >
          ...
          {images.map((img, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: '6px',
                border:
                  i === activeIndex ? '2px solid #bc6f21' : '1px solid #e5e5e5',
                overflow: 'hidden',
                cursor: 'pointer',
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <div
              className="relative w-full md:w-[65%] lg:w-[70%] bg-[#f5f5f5] flex items-center justify-center rounded-md overflow-hidden"
            ...
            <div className="w-full md:w-[35%] lg:w-[30%] flex flex-col bg-white overflow-y-auto pr-2">
              <h2 className="text-xl md:text-2xl font-bold text-neutral-900 mb-6 leading-tight">
                {productName}
              </h2>
